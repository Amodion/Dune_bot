...
Я работаю через команды, прямо из строки и через кнопки.

Напиши `/roll`, чтобы открыть меню настройки броска кнопками.
...
Просто тегни бота и  напиши "14" так и бот скажет, сколько ты получил успехов, с целевым значением 14!
